...
RESOURCES += src/qt/aqa.qrc src/qt/aqa_locale.qrc

TRANSLATIONS += src/qt/locale/aqa_bg.ts \
                src/qt/locale/aqa_de.ts \
                src/qt/locale/aqa_en.ts \
                src/qt/locale/aqa_es.ts \
                src/qt/locale/aqa_fi.ts \
                src/qt/locale/aqa_fr.ts \
                src/qt/locale/aqa_it.ts \
                src/qt/locale/aqa_ja.ts \
                src/qt/locale/aqa_pl.ts \
                src/qt/locale/aqa_pt.ts \
                src/qt/locale/aqa_ru.ts \
                src/qt/locale/aqa_sk.ts \
                src/qt/locale/aqa_sv.ts \
                src/qt/locale/aqa_vi.ts \
                src/qt/locale/aqa_zh_CN.ts \
                src/qt/locale/aqa_zh_TW.ts
