...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='aqa.conf'
CONFIGFOLDER='/root/.aqa'
COIN_DAEMON='aqad'
COIN_CLI='aqa-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/aquilacore/aqa.git'
COIN_TGZ='https://github.com/aquilacore/aqa/releases/download/v1.1.0.0/Aqa-1.1-linux.tar.gz'
