...
The Aqa project operates an open contributor model where anyone is
...
The following applies to code changes to the Aqa project, and is not to be
confused with overall AQA Network Protocol consensus changes.

Whether a pull request is merged into Aqa rests with the project merge
...
Patches that change AQA consensus rules are considerably more involved than
...
Where a patch set proposes to change the AQA consensus, it must have been
...
The project leader is the release manager for each Aqa release.
