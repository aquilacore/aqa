...
def run_bind_test(tmpdir, allow_aqa, connect_to, addresses, expected):
    '''
    ...
    if allow_aqa:
        base_args += ['-rpcallowip=' + x for x in allow_aqa]
...
def run_allowip_test(tmpdir, allow_aqa, rpchost, rpcport):
    '''
    Start a node with rpcwallow IP, and request getinfo
    at a non-localhost IP.
    '''
    base_args = ['-disablewallet', '-nolisten'] + ['-rpcallowip='+x for x in allow_aqa]
