...
#if defined(NDEBUG)
#error "AQA cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight <= 4) {
      nSubsidy = 10000 * COIN;
    } else if (nHeight > 4 && nHeight <= 5760) {
      nSubsidy = 1 * COIN;
    } else if (nHeight > 5760 && nHeight <= 44640) {
      nSubsidy = 30 * COIN;
    } else if (nHeight > 44640 && nHeight <= 54720) {
      nSubsidy = 30 * 0.9 * COIN;
    } else if (nHeight > 54720 && nHeight <= 64800) {
      nSubsidy = 30 * 0.8 * COIN;
    } else if (nHeight > 64800 && nHeight <= 74880) {
      nSubsidy = 30 * 0.7 * COIN;
    } else if (nHeight > 74880 && nHeight <= 84960) {
      nSubsidy = 30 * 0.6 * COIN;
    } else if (nHeight > 84960 && nHeight <= 95040) {
      nSubsidy = 30 * 0.5 * COIN;
    } else if (nHeight > 95040 && nHeight <= 105120) {
      nSubsidy = 30 * 0.4 * COIN;
    } else if (nHeight > 105120 && nHeight <= 115200) {
      nSubsidy = 30 * 0.3 * COIN;
    } else if (nHeight > 115200 && nHeight <= 125280) {
      nSubsidy = 30 * 0.2 * COIN;
    } else if (nHeight > 125280) {
      nSubsidy = 30 * 0.1 * COIN;
    }
