...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getchaintaqa", &getchaintaqa, true, false, false},
        ...
        /* Aqa features */
        {"aqa", "masternode", &masternode, true, true, false},
        {"aqa", "listmasternodes", &listmasternodes, true, true, false},
        {"aqa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aqa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aqa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aqa", "masternodedebug", &masternodedebug, true, true, false},
        {"aqa", "startmasternode", &startmasternode, true, true, false},
        {"aqa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aqa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aqa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aqa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aqa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aqa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aqa", "mnbudget", &mnbudget, true, true, false},
        {"aqa", "preparebudget", &preparebudget, true, true, false},
        {"aqa", "submitbudget", &submitbudget, true, true, false},
        {"aqa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aqa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aqa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aqa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aqa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aqa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aqa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aqa", "checkbudgets", &checkbudgets, true, true, false},
        {"aqa", "mnsync", &mnsync, true, true, false},
        {"aqa", "spork", &spork, true, true, false},
        {"aqa", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aqa", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use aqad, or the -server option to aqa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> aqa-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55331/\n";
}
