/* src/config/aqa-config.h.  Generated from aqa-config.h.in by configure.  */
/* src/config/aqa-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "aquilatrade.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aqa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aqa Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aqa"
