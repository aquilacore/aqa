...
void Intro::setDataDirectory(const QString& dataDir)
{
    ...
    if (dataDir == getDefaultDataDirectory()) {
        ...
        ui->ellaqaisButton->setEnabled(false);
    } else {
        ui->dataDirCustom->setChecked(true);
        ui->dataDirectory->setEnabled(true);
        ui->ellaqaisButton->setEnabled(true);
    }
}
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the aqa.conf file in the default data directory
     * (to be consistent with aqad behavior)
     */
    if (dataDir != getDefaultDataDirectory())
...
void Intro::on_ellaqaisButton_clicked()
{
