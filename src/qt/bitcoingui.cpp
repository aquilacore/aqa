...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AQA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aqa: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aqa"), this);
    aboutAction->setStatusTip(tr("Show information about Aqa"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AQA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AQA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AQA addresses"));
    ...
    openAction->setStatusTip(tr("Open a AQA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aqa help message to get a list with possible AQA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aqa client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AQA network", "", count));
}
...
{
    QString strTitle = tr("Aqa"); // default title
