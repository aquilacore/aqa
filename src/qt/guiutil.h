...
/** Utility functions used by the AQA Qt UI.
 */
namespace GUIUtil
{
...
// Render AQA addresses in monospace font
...
// Parse "aqa:" URI into recipient object, return true on successful parsing
...
/** Qt event filter that intercepts ToolTipChange events, and replaces the tooltip with a rich text
      ...
      Tooltaqa longer than the provided size threshold (in characters) are wrapped.
     */
