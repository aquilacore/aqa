...
In order to support loading of multiple wallets in aqa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aqa.cpp.
...
Changes to aqa.cpp
----------------------
aqa.cpp is the entry point into aqa-qt, and as such, will require some minor modifications to provide hooks for
